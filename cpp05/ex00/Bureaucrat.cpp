...
Bureaucrat::Bureaucrat(const char* str, const int grade) : __name(str ? str : "default"), __grade(validateGrade(grade)) {}
...
const std::string&	Bureaucrat::getName(void) const { return __name; }
